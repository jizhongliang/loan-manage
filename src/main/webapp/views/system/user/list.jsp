				...
				<div class="app-init-container">
					<div class="js-list-filter-region clearfix ui-box" style="position: relative; margin-bottom: 15px;">
						<div class="widget-list-filter">
							<a class="btn btn-small btn-green" id="add" onclick="edit('');">新增用户</a>
						</div>
					</div>
	...
	<script type="text/javascript">
        ...
        $(function(){
            searchtable =  $('#table_list').dataTable({
                ...
                "iDisplayLength":10,
                "ajax": {
                    "url": "${path}/sysUserMana/searchUserList.shtml"
                },
        ...
        function edit(id) {
            layer.open({
				...
				resize: false,
                maxmin: false,
                content: "${path}/sysUserMana/editUserPage.shtml?id="+id
            });
        }

		function delCat(id){
            layer.confirm('您确认要删除该用户？', {
                btn: ['确认','取消'] //按钮
            }, function(){
                $.post("${path}/sysUserMana/deleteOneUser.shtml",{id:id},function(result){
