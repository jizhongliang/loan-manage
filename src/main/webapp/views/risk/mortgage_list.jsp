						...
						<form class="f-12" id="order-filter-form" onsubmit="return false;" autocomplete="off">
							<p class="ml40">
								...
								<select class="select-normal"  name="status" id="status">
									...
									<option value="10">初审订单</option>
									<option value="20">复审订单</option>
									<option value="30">终审订单</option>
...
<script type="text/javascript">
    ...
    $(function(){
        searchtable =  $('#table_list').dataTable({
            ...
            "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                var a = {
                    'editTable':
                    '<a onclick=userMsg(\"' + aData.id + '\");>详细信息</a>'
                }
    ...
    function userMsg(id){
        layer.open({
            ...
            resize: false,
            maxmin: false,
            content: "${path}/riskMana/mortgageUserPage.shtml?id="+id
        });
    }
